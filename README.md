# **Deteksi Objek Menggunakan Tensorflow JS dan React JS** 
#### Deteksi objek yang tertangkap di kamera mu :)

* Demo : https://fiqobjectdetect.netlify.app/
 ditunggu dulu ya sebentar soalnya load model agak lama tergantung koneksi
...
* Install dulu Node Modules-nya dengan cara :
```js
npm install
```

* Yaudah terus run aja pake command :
```js
npm start
```
...
* Sudah pasti Tensorflow JS dan React JS
* Model yang digunakan adalah COCO SSD (tambah penjelasan COCO SSD biar README-nya panjang)
